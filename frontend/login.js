// summit login.js: handles does stuff auto automatically redirecting if you are logged in, getting the hostname, or knowing when to show the auth fail message
